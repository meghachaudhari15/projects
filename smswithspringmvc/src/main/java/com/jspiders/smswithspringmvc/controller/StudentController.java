...
public class StudentController {
	...
	@RequestMapping(path="/student_id",method=RequestMethod.GET)
	...
	@RequestMapping(path = "/student_id",method = RequestMethod.POST)
	public String searchStudentById(@RequestParam long id,ModelMap modelMap) {
		StudentPOJO student=studentService.searchStudentById(id);
		modelMap.addAttribute("student", student);
		return "student_id";
	}
	...
	public String searchStudentByEmail(@RequestParam String pattern, ModelMap modelMap) {
		List<StudentPOJO> students = studentService.searchStudentByEmail(pattern);
		modelMap.addAttribute("students", students);
		return "search_em";
	}	
